                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">EDIT Staff </h1>
                            </div>
                            <form class="" action ="/users/update/<?=$users['employee_id']?>" method="post">
                            ...
                            <div class="form-group">
                               ...
                               <div class="form-group row">
                                ...
                                <a href="/staff" class =  "btn btn-danger float-right"  name ="add_user" >
