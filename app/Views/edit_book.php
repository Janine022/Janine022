                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">EDIT Book Information</h1>
                            </div>
                            ...
                            <div class="">
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name="book_title" id="book_title"
                                            placeholder="Book Title" value="<?= $user_data['book_title']?>" >
                                    </div>
                                
                                 </div>
                                <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="author" id="author"
                                            placeholder="Author Name" value="<?= $user_data['author']?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    id="description"  ><?= $user_data['description']?></textarea>
                                    
                                    </div>
                                </div>

                                <div class="form-group">
                                    <input type="date" class="form-control form-control-user" name="date_publication" id="date_publication"
                                        placeholder=" Publication Date " value="<?= $user_data['date_publication']?>">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="isbn" id="isbn"
                                        value="<?= $user_data['isbn']?>">
                                </div>

                                <div class="form-group">
                                <select name ="category" class="form-control" id="category">
                             
                                <option value ="<?= $user_data['category']?>"><?= $user_data['category']?></option>
                                ...
                                <a href="/book" class =  "btn btn-danger float-right"  name ="add_customer" >
